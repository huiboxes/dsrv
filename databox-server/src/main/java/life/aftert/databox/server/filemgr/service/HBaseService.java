...
import life.aftert.databox.server.DxServerException;
...
public class HBaseService {
    ...
    public static boolean createTable(Connection connection, String tableName, String[] cfs,
        ...
        try (HBaseAdmin admin = (HBaseAdmin) connection.getAdmin()) {
            ...
            throw new DxServerException(ErrorCodes.ERROR_HBASE, msg);
        }
        return true;
    }
     ...
     * @return success of failed
     */
    public static boolean putRows(final Connection connection, final String tableName, final List<Put> puts) {
